...
Параметры:
{options}
Assistant:Правильный ответ{answer}.<eos>
"""
...
Optionen:
{options}
Assistant:Die richtige Antwort ist{answer}.<eos>
"""
...
Opções:
{options}
Assistant:A resposta correta é{answer}.<eos>
"""
...
Opzioni:
{options}
Assistant:La risposta corretta è{answer}.<eos>
"""
