...
Параметры:
{options}
Assistant:Правильный ответ{answer}.<|endoftext|>
"""
...
Optionen:
{options}
Assistant:Die richtige Antwort ist{answer}.<|endoftext|>
"""
...
Opções:
{options}
Assistant:A resposta correta é{answer}.<|endoftext|>
"""
...
Opzioni:
{options}
Assistant:La risposta corretta è{answer}.<|endoftext|>
"""
...
옵션:
{options}
Assistant:정답은{answer}.<|endoftext|>
"""
...
オプション:
{options}
Assistant:正しい答えは、{answer}.<|endoftext|>
"""
...
def preprocess(args):
    ...
    for source, items in grouped_items.items():
        ...
        elif source in ['frenchmedmcqa','mmlu-medical-fr']:
        ...
        elif source in ['MedExpQA','mmlu-medical-it']:
