...
def plot(input_path):
    ...
    output_path=os.path.join(os.path.dirname(input_path),f'{title_name}_new.jpg')
    ...
    with open(input_path,'r',encoding='utf-8') as f:
        ...
        ax=sns.heatmap(data=np_data,annot=True,cmap='Reds',vmin=0,vmax=1,fmt='.2f',square=False,cbar=False,
