...
def train(args):
    ...
    left_tokenizer = AutoTokenizer.from_pretrained(args.model_path, trust_remote_code=True, padding_side='left', pad_token='<|end_of_text|>', eos_token='<|end_of_text|>')
    ...
    if args.eval_step <= 0:
        args.eval_step=len(train_dataloader) // 40
